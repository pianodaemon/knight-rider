...
interface Reporte57Slice {
  report: Reporte57 | null;
  loading: boolean;
}

const initialState: Reporte57Slice = {
  report: null,
  loading: false,
};

export const sliceName = 'report57Slice';
export const result57Reducer = createAndMergeSliceReducer(
  sliceName,
  initialState,
  null
);
