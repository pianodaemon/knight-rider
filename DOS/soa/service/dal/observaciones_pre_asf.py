...
def read_per_page(offset, limit, order_by, order, search_params, per_page, page, indirect_search_params):
    ...
    order_by_values = (
        'id', 'programa_social_id', 'auditoria_id', 'observacion', 'num_observacion', 'direccion_id'
    )
    ...
    entities = page_entities('observaciones_pre_asf', offset + whole_pages_offset, target_items, order_by, order, search_params)
