...
def _alter_result_report(**kwargs):
    """Calls sp in charge of create and edit a result report"""
    sql = """SELECT * FROM alter_result_report(
        {}::integer,
        {}::integer,
        {}::integer,
        {}::integer,
        ...
        AS result( rc integer, msg text )""".format(
            kwargs["id"], 
            kwargs["observation_type_id"], 
            kwargs["observation_code_id"],
            kwargs["observation_bis_code_id"], 
            ...
            kwargs['division_id'], 
            kwargs['hdr_doc'],
            kwargs['hdr_reception_date'], 
            kwargs['hdr_expiration1_date'], 
            kwargs['hdr_expiration2_date']
        )
...
def create(**kwargs):
    ''' Creates an result report entity '''
    kwargs['id'] = 0
