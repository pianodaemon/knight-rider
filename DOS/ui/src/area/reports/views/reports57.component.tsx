    ...
    <table className={classes.tableWhole} id="table-to-xls"> 
      <tbody className={classes.tableReports} >
        ...
        <tr style={{display: 'none'}} >    
          <th colSpan={8} > Reporte Ejecutivo Concentrado de Observaciones por Tipo de Observación </th> 
        </tr> 
        <tr style={{display: 'none'}} >    
        </tr> 
        <tr style={{display: 'none'}} >    
        ...
        <tr> 
          ...
          <td style={{fontWeight: "bold", textAlign: "right"}}> <MoneyFormat isVisibleFiscal={true} monto={sum_monto.valueOf()} /> </td>
          <td style={{fontWeight: "bold", textAlign: "right"}}> 100 %</td>
        </tr>
      </tbody>
    </table>
