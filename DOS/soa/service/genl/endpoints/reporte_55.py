...
data_row = api.model('Data row (Reporte 55)', {
    ...
    'c_sfp':       fields.Integer(description=reporte_55_ns_captions['cant_obs']),
    'm_sfp':       fields.Float(description=reporte_55_ns_captions['monto_aten']),
    'c_na_sfp':    fields.Integer(description=reporte_55_ns_captions['cant_obs_no_aten']),
    'm_na_sfp':    fields.Float(description=reporte_55_ns_captions['monto_no_aten']),
    'c_a_sfp':     fields.Integer(description=reporte_55_ns_captions['cant_obs_aten']),
    'm_a_sfp':     fields.Float(description=reporte_55_ns_captions['monto_aten']),
