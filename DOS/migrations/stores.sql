...
--
-- Name: alter_result_report(integer, integer, integer, integer, integer, integer, integer, text, double precision, double precision, double precision, text, date, date, date, date, date, text, text, text, text, text, integer, text, date, date, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
CREATE FUNCTION public.alter_result_report(
        ...
        _hdr_doc text, 
        _hdr_reception_date date, 
        _hdr_expiration1_date date, 
        _hdr_expiration2_date date
    ) RETURNS record
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION public.alter_result_report(
    ...
    _hdr_reception_date date, 
    _hdr_expiration1_date date, 
    _hdr_expiration2_date date) OWNER TO postgres;
